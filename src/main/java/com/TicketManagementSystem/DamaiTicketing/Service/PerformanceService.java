...
public class PerformanceService extends ServiceImpl<PerformanceMapper, Performance> {
    ...
    public Page<Performance> getPerformance(int pageNum, HttpServletRequest request) {
        ...
        if (!StpUtil.isLogin()) {
            ...
            result = this.lambdaQuery()
                    .eq(Performance::getCity, performLocationService.returnPerformanceByIP(request))
                    .page(page);
        }
    ...
    public Page<Performance> selectPerformanceByParams(String city, String category, int pageNum) {
        ...
        Page<Performance> result =  this.lambdaQuery()
                .like(city != null, Performance::getCity, city)
                .like(category != null, Performance::getCategory, category)
                .page(page);
